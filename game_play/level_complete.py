...
def process(game, level_id, boss_defeated, monster):
    ...
    level = game.dungeon.levels[level_id-1]
    ...
    if boss_defeated:
        ...
        game.character.inventory.append(monster.special_drop)
        contents += "\n" + monster.name + " Dropped... " + monster.special_drop["name"] + "!!!"
